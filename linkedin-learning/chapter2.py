...
def string_combiner(*args, unique=False):
    """
    string_combiner(*args, unique=False) -> string

    This function combines passed strings and numbers into one string.
    
    Parameters:
    args: list of strings and numbers to combine
    unique: if True, the result has only 1 instance of each character from the input
    """
